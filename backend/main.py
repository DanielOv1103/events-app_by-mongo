...
app.include_router(city_router, prefix="/city", tags=["ciudades"])
app.include_router(restaurant_router, prefix="/restaurants", tags=["restaurantes"])
app.include_router(airport_router, prefix="/airport", tags=["aeropuertos"])
app.include_router(cinema_router, prefix="/cinema", tags=["cines"])